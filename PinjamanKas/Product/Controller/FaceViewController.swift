...
class FaceViewController: BaseViewController {
    ...
    lazy var twoImageView: UIImageView = {
        ...
        twoImageView.image = languageCode == "701" ? UIImage(named: "in_ad_c_image") : UIImage(named: "fac_tw_a_image")
        return twoImageView
    }()
    ...
    lazy var aImageView: UIImageView = {
        ...
        aImageView.image = UIImage(named: "de_fac_a_image")
        return aImageView
    }()
    ...
    lazy var cImageView: UIImageView = {
        ...
        cImageView.image = languageCode == "701" ? UIImage(named: "af_foot_ac_image") : UIImage(named: "f_fac_a_image")
...
extension FaceViewController {
    ...
    @objc func tapClick() {
        let cronies = self.model?.sagged?.park?.cronies ?? 0
        if cronies == 0 {
            cameraManager = SimpleCameraManager(presentingVC: self)
            cameraManager?.takePhoto(position: .front) { [weak self] data in
                guard let self = self else { return }
